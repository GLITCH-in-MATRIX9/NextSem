...
// // 2. Create Mock Data matching your filter options
...
//     image: "/card22.png" // using existing assets or placeholders
//   },
//   {
//     id: 3,
//     name: "Rohan Mehta",
...
//   // State for the list being displayed
...
//       // Filter by Interests (Show buddy if they match ANY of the selected interests)
//       // If no interests selected, match all.
//       const interestMatch = selectedInterests.length === 0 
//         ? true 
//         : buddy.interests.some(buddyInterest => selectedInterests.includes(buddyInterest));
...
//               {/* Note: Logic is now instantaneous via useEffect, so "Apply" isn't strictly needed for logic but good for UX or could be removed if real-time */}
...
//                   </svg>
//                 </button>
//                 <button className="p-2 rounded-lg bg-black text-white border-2 border-black transition-all">
//                   <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
//                     <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
//                   </svg>
//                 </button>
...
//                     <div className="relative mb-4">
//                       <div className="w-full aspect-square rounded-2xl bg-black overflow-hidden border-4 border-gray-200 group-hover:border-black transition-all">
//                         {/* Note: Using a fallback src if image is missing, or rely on Next/Image behavior */}
//                         <Image
...
//                           <span key={tag} className="px-2 py-1 bg-gray-100 text-black text-xs font-bold rounded-lg border border-black">
//                             {tag}
//                           </span>
//                         ))}
...
//                   We couldn't find any study buddies matching your current filters. Try adjusting your criteria.
//                 </p>
//                 <button 
//                   onClick={clearFilters}
  ...
  return (
    <div className="min-h-screen bg-white relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-8">
        ...
        {/* Bottom CTA - Updated to Trigger Modal */}
        <div className="bg-black rounded-[50px] p-8 md:p-12 text-center relative overflow-hidden animate-fade-in-up shadow-2xl">
          ...
          <div className="relative z-10">
            ...
            <button 
              ...
              className="px-8 py-4 bg-white text-black font-black rounded-xl shadow-xl hover:bg-gray-200 transform hover:scale-105 transition-all"
            >
              Create Study Request
            </button>
          </div>
